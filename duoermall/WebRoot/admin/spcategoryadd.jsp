...
<body>
	<div class="search-title">
                ...
                <div class="description">
				    ...
				    <form name="spcategoryform" method="post" action="<%=SystemParam.getSiteRoot()%>/admin/spcategorymanager.do"  id="spcategoryForm">
				        <table class="grid" cellspacing="1" width="100%">
						        ...
						        <input type="hidden" name="actiontype" value="${actiontype}" />
						         <input type="hidden" name="seedid" value="${seedid}" />
											   ...
											   <td>
												   <input name="mingcheng" validate="{required:true,messages:{required:'请输入名称'}}" value="${requestScope.spcategory.mingcheng}" class="input-txt" type="text" id="txtMingcheng"  />
												</td>
											   </tr>
											 <tr>
											   <td align="right" >介绍:</td>
											   <td colspan="3">
													<textarea   name="jieshao"   id="txtJieshao" style="width:98%;height:200px;"  >${requestScope.spcategory.jieshao}</textarea>
											   </td>
											 </tr>
				        </table>
		     <div class="ui-button">
