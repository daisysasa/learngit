...
<body>
			...
			<form name="xinxiform" method="post"
				...
				<table class="grid" cellspacing="1" width="100%">
					...
					<input name="pubren" type="hidden" value="${adminuser.username}"  />
					...
					<tr>
						...
						<td colspan="3"><textarea name="zhaiyao" id="txtZhaiyao"
								style="width:98%;height:120px;">${requestScope.xinxi.zhaiyao}</textarea>
						</td>
					</tr>
					<tr>
